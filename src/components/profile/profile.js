...
class Profile extends Component {
        ...
        <img
          ...
          src={
            values.file_obj !== null
              ? values.file_obj
              : process.env.REACT_APP_API_URL +"uploaded/images/user.png"
          }
  ...
  getData = async id => {
    await axios
      ...
      .then(response => {
        ...
        document.getElementById("avatars").src = "http://localhost:8080/uploaded/images/"+response.data.avatars
  ...
  render() {
    ...
    console.log("rersult no render do profile "+ result);
    return (
